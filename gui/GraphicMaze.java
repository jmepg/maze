...
public class GraphicMaze extends JPanel implements KeyListener {
	...
	public static final int vSize = 700;
	...
	//public static void main(String[] args) {
		...
		/*GameEngine g = new GameEngine(2);
		g.initializeGame();

		JFrame f = new JFrame();
		f.setSize(new Dimension(hSize, vSize));
		 ...
		 * window = new gui(); window.frame.setVisible(true); } catch (Exception
		 * e) { e.printStackTrace(); } } });
		 */
	//}
	...
	//private void initialize() {
		...
		/*
		 * frame = new JFrame("Projeto Guiado"); frame.setSize(new
		 * Dimension(800, 600));
		...
		/*
		 * JPanel panel = new JPanel(); panel.setPreferredSize(new
		 * Dimension(100, 100)); panel.setMinimumSize(new Dimension(100, 100));
		 * frame.getContentPane().add(panel, BorderLayout.EAST); GridBagLayout
		 * gbl_panel = new GridBagLayout(); gbl_panel.columnWidths = new int[]
		 * {0, 5}; gbl_panel.rowHeights = new int[] {0, 0, 5};
		 ...
		 * gbc_btnNewButton.gridy = 0; panel.add(btnNewButton,
		 * gbc_btnNewButton);
		 * 
		 ...
		 * gbc_btnNewButton_1.gridx = 0; gbc_btnNewButton_1.gridy = 1;
